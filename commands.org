...
#+AUTHOR: FFFluoride
#+LANGUAGE: en
#+OPTIONS: ':nil *:t -:t ::t <:t \n:nil ^:t arch:headline author:t expand-links:t broken-links:mark c:nil creator:t d:(not "LOGBOOK") date:t e:t f:t H:3 inline:nil num:t pri:nil prop:nil stat:t tags:t tasks:t tex:t timestamp:t |:t toc:1
...
* How to run
To extract source code in emacs use the =org-babel-tangle= (=C-v C-t=)
