...
* TODO Goals [1/7]
  ...
  - [ ] Have =commands= be a queue of getting filenames and downloading audio of individual vids so that I can implement sleeping as a [[https://github.com/yt-dlp/yt-dlp?tab=readme-ov-file#workarounds][workaround]] avoiding "Too many requests" error
