...
#+transclude: [[file:table-lookup-settings.org::*Content][Content]]
...
* Data
#+CAPTION: This is a table matching the playlist names with their youtube playlist ids
...
#+CAPTION: This is a table with some bash commands
#+ATTR_HTML: :border 2 :rules all :frame border
#+NAME: op-table
| operation            | command                                                               |
|----------------------+-----------------------------------------------------------------------|
